...
-   Open access under a [Creative Commons Attribution 4.0 International License](http://creativecommons.org/licenses/by/4.0/), and freely [downloadable](https://analytics.hathitrust.org/datasets)
...
HTRC Extracted Features API [documentation](https://htrc.stoplight.io/docs/ef-api/06db4dc572b49-ef)
